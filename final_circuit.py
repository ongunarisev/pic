...
wbg_circuit_name = "WBGc"
wbg_circuit = WBGCircuit(wbg=wbg, name=wbg_circuit_name)

insts[wbg_circuit_name] = wbg_circuit
specs.append(i3.Place(wbg_circuit_name, (x0, y0)))
